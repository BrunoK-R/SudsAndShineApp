...
private data class LoyaltyReportSummaryPayload(
    ...
    fun toAdminLoyaltyReportSummary(): AdminLoyaltyReportSummary = AdminLoyaltyReportSummary(
        ...
        bonusStamps = bonusStamps.coerceAtLeast(0),
        totalStamps = totalStamps.takeIf { it > 0 }?.coerceAtLeast(0)
            ?: (qualifyingWashes.coerceAtLeast(0) + bonusStamps.coerceAtLeast(0)),
        adjustmentsScanned = adjustmentsScanned.coerceAtLeast(0),
        truncated = truncated,
